...
class MobileNet(nn.Module):
    def __init__(self, n_class,  profile='normal'):
        ...
        # 0.5 AMC
            ...
            in_planes = 24
            cfg = [48, (80, 2), 96, (160, 2), 184, (368, 2), 368, 368, 368, 368, 408, (704, 2), 744]
        elif profile == 'BN_best':
            in_planes = 18
            cfg = [64, (75, 2), 93, (183, 2), 170, (373, 2), 323, 312, 332, 363, 426, (748, 2), 845]
        elif profile == 'BN_4':
            in_planes = 20
            cfg = [52, (82, 2), 92, (160, 2), 183, (389, 2), 365, 340, 332, 357, 381, (694, 2), 862]
        else:
